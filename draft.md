...
Il chiffre, planifie et développe les créations et évolutions des transactions sur les progiciels utilisés dans l'entreprise. Les principaux progiciels utilisés sont Selligent − CRM, Cognos − Décisionnel − et SAP − ERP. Le pôle est divisé en sous-sections : une sous-section par dédiée par progiciel. Il y a également un pôle Web, qui s'occupe de dévelpper des outils spécifiques qui ne peuvent pas être réalisés avec les autres progiciels.
Chaque pôle dispose d'une contrepartie en Roumanie et est composé de 3 à 6 personne. Le pôle le plus important en terme de taille est le pôle SAP.
Le pôle SAP comptabilise
